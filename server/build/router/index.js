...
module.exports = function (app) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    uuid = require('uuid');
                    req.body.id = uuid.v1();
                    return [4 /*yield*/, req.Model.create(req.body)];
                case 1:
                    model = _a.sent();
                    res.send(model);
                    return [2 /*return*/];
    ...
    router.get('/', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, req.Model.findAll()];
                case 1:
                    models = _a.sent();
                    res.send(models);
                    return [2 /*return*/];
    ...
    router.get('/:id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, req.Model.findOne({
                        where: {
                            id: req.params.id
                        }
                    })];
    ...
    router.put('/', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, req.Model.update(req.body)];
                case 1:
                    model = _a.sent();
                    res.send(model);
                    return [2 /*return*/];
    ...
    router.delete('/:id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, req.Model.destroy({
                        where: {
                            id: req.params.id
                        }
                    })];
    ...
    app.use(userRouter);
    // 错误处理函数
    app.use(function (err, req, res, next) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            // console.log(err)
